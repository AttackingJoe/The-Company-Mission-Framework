...
spectate_events = compile preprocessFileLineNumbers format ["tb3\s\spec\specta_events.sqf"];
RefreshPlayerList = compile preprocessFileLineNumbers format ["tb3\s\spec\RefreshPlayerList.sqf"];
FreeLookMovementHandler = compile preprocessFileLineNumbers format ["tb3\s\spec\FreeLookMovementHandler.sqf"];
CameraMenuHandler = compile preprocessFileLineNumbers format ["tb3\s\spec\CameraMenuHandler.sqf"];
PlayerMenuHandler = compile preprocessFileLineNumbers format ["tb3\s\spec\PlayerMenuHandler.sqf"];
KEGsShowCombatMode = compile preprocessFileLineNumbers format ["tb3\s\spec\specta_combatmode.sqf"];
KEGsShowUnitLocator = compile preprocessFileLineNumbers format ["tb3\s\spec\specta_locator.sqf"];
