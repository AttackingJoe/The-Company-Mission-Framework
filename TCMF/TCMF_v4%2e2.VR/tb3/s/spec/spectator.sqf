...
setAperture -1;
sleep 1;
gdtmod_seagull_camera = "camconstruct" camcreate [getPos specloc select 0, (getPos specloc select 1), (getPos specloc select 2)+50];
gdtmod_seagull_camera setdir (getdir specloc);	
gdtmod_seagull_camera camConstuctionSetParams [getPos specpen, 20000, 10000];
